...
local kp =
  ...
  // https://github.com/prometheus-operator/kube-prometheus#stripping-container-resource-limits
  ...
  + {
    _config+:: {
      ...
      // https://github.com/prometheus-operator/kube-prometheus#monitoring-all-namespaces
      prometheus+:: {
        namespaces: [],
        replicas: 1,
      },
    ...
    grafana+:: {
      ...
      storage:
        // https://github.com/rancher/local-path-provisioner/blob/master/examples/pvc.yaml
        pvc.new()
